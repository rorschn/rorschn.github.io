...
$(window).on('load', function () {
    ...
    switch (body.attr('data-page')) {
        ...
        case "index":
            ...
            $( "#profit-breakdown" ).hide();
            $( "#profit-toggle" ).on( "click", function() {
                $( "#profit-breakdown" ).slideToggle();
                if($( "#profit-toggle" ).html() == "►" ){
                    $( "#profit-toggle" ).html("▼");
                }else{
                    $( "#profit-toggle" ).html("►");
                }
            ...
            $( "#mihal-pobul-explanation-text" ).hide();
            $( "#mihal-pobul-explanation" ).on( "click", function() {
                $( "#mihal-pobul-explanation" ).hide();
                $( "#mihal-pobul-explanation-text" ).toggle( "slow" );
                return false;
            });

            $.ajaxSetup({
                beforeSend: function(xhr) {
                    xhr.setRequestHeader('X-Api-Key', '47fb61d3969d48fa9eeab4ce679da1d1');
                }
            });

            $.ajax('https://legend.lnbits.com/usermanager/api/v1/users').done(function( msg ) {
                console.log( msg );
              });
        ...
        case 'stats':
            ...
            // progressCircles2.text.style.fontSize = '20px';
            progressCircles2.animate(0.93);  // Number from 0.0 to 1.0
